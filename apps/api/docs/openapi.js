...
const jsonResp = (description, schema) => ({ description, content: { 'application/json': { schema } } });
  ...
  paths: {
    ...
    '/carts/find/{userId}': {
      ...
      put: {
        ...
        requestBody: jsonBody({ type: 'object', properties: { products: cart.properties.products } }),
    ...
    '/orders': {
      post: {
        ...
        requestBody: jsonBody({
          ...
          properties: { products: order.properties.products, amount: { type: 'number' }, address: { type: 'object' } },
        }),
    ...
    '/wishlist/find/{userId}': {
      ...
      put: {
        ...
        requestBody: jsonBody({ type: 'object', properties: { products: wishlist.properties.products } }),
        responses: { 200: jsonResp('OK', wishlist), 403: r[403] },
      },
    },
    '/wishlist/{productId}': {
