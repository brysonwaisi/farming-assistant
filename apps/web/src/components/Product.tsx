...
// Shape consumed by the card. Compatible with both the cart payload
// (addProduct) and the wishlist toggle (WishlistProduct), so extra
// server fields ride along via the index signature.
